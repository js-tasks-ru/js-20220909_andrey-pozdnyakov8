...
export default class ColumnChart {
  ...
  async fetchData() {
    ...
    const urlFromToParams = new URL(pathNameURL);
    urlFromToParams.searchParams.set('from', this.range.from.toISOString());
    urlFromToParams.searchParams.set('to', this.range.to.toISOString());
